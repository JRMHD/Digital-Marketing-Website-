                            ...
                            <div class="single-sidebar-widget">
                                ...
                                <div class="service-widget-categories">
                                    <ul>
                                        ...
                                        <li class="active">
                                            <a href="service-details.html">Social Media Mesketing</a><span><i
                                        ...
                                        <li>
                                            <a href="service-details.html">Search Engine Marketing (SEM)</a>
                                            <span><i class="fa-regular fa-arrow-right-long"></i></span>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="service-details-content">
                            ...
                            <div class="details-list-items">
                                <ul class="details-list">
                                    <li>
                                        <i class="fa-solid fa-circle-check"></i>Various analysis
                                        options.
                                    </li>
                                    <li>
                                        <i class="fa-solid fa-circle-check"></i>Advance Data
                                        analysis operation.
                                    </li>
                                </ul>
                                <ul class="details-list">
                                    <li>
                                        <i class="fa-solid fa-circle-check"></i>Page Load (time,
